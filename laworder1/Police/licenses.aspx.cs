...
namespace laworder1.Police
{
    public partial class licenses : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                lblPolice.Text = Session["police"].ToString();
            }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (ddlLicense.SelectedItem.Text == "Loud Speaker")
            {
                if (ddlAccept.SelectedItem.Text == "Accept")
                {
                    ...
                    tbl = new DataTable();
                    da.Fill(tbl);
                    Session["police"] = "Updated!License has been approved for :" + txtUserMail.Text + ".";
                ...
                else
                {
                    ...
                    Session["police"] = "Updated!License has been rejected for :" + txtUserMail.Text + ".";
                    Response.Redirect("licenses.aspx");
                }
            }
